...
<head>
  ...
  <title>Edit Sambhavana Items | SARVAH</title>
...
<div class="pagetitle">
  ...
  <nav>
    ...
    <li class="breadcrumb-item">Sambhavana</li>
	  <li class="breadcrumb-item active">Edit SAmbhavana Items</li>
	</ol>
  </nav>
</div><!-- End Page Title -->
  ...
  <div class="row">
	<div class="col-lg-12">
      ...
      <form class="row g-3" action="" id="invoice-form" method="post" class="invoice-form" role="form" novalidate="">
                ...
                <div class="col-12">
                  <div class="form-floating">
                    <textarea class="form-control" placeholder="Item Description" name="itemDescription" id="itemDescription" style="height: 100px;"><?php echo $item['itemdesc'];  ?></textarea>
