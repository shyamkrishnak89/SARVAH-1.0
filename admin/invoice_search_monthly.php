...
<head>
  ...
  <title>Search Invoice - Monthly | SARVAH</title>
...
<body>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Search Monthly Invoice List</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
  ...
  <div class="row">
	<div class="col-lg-12">
      ...
      <form class="row g-3" id="invoice-form" method="post" action="search_inv_monthly.php" class="invoice-form" role="form" novalidate="">
                
                
                <div class="col-md-4">
                  <div class="form-floating">
                    <input type="date" class="form-control" id="order_date_from" name="order_date_from" placeholder="order_date_from">
                    <label for="order_date_from">Invoice From Date</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-floating">
                    <input type="date" class="form-control" id="order_date_to" name="order_date_to" placeholder="order_date_to">
                    <label for="order_date_to">Invoice To Date</label>
                  </div>
                </div>
