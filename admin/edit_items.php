...
if(!empty($_GET['update_id']) && $_GET['update_id']) {
	$item = $invoice->getItemByID($_GET['update_id']);		
}
if(!empty($_POST['itemName']) && $_POST['rate']) {	
	$invoice->updateItemByID($_POST);
	header("Location:add_vazhipadu_items.php");
}
?>
...
<head>
  ...
  <title>Edit Vazhipadu Items</title>
...
<section class="section">
  <div class="row">
	<div class="col-lg-12">
	  ...
	  <div class="card">
		<div class="card-body">
		  <h5 class="card-title">Edit Vazhipadu Items</h5>
  ...
  <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Vazhipadu Items List</h5>
