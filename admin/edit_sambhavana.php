...
if(!empty($_GET['update_id']) && $_GET['update_id']) {
	$invoiceValues = $invoice->getSambhavanaInvoice($_GET['update_id']);		
	$invoiceItems = $invoice->getSambhavanaByID($_GET['update_id']);	
...
<section class="section">
  <div class="row">
	<div class="col-lg-12">
	  ...
	  <div class="card">
		<div class="card-body">
		  <h5 class="card-title">Update Sambhavana Invoice</h5>
	  ...
	  <div class="card">
		<div class="card-body">
		  ...
		  <form class="row g-3" action="" id="invoice-form" method="post" class="invoice-form" role="form" novalidate="">
			...
			<div class="col-md-6">
			  <div class="form-floating">
				<input type="number" value="<?php echo $invoiceValues['amountOffered']; ?>" class="form-control" id="subTotal" name="subTotal" placeholder="Sub Total" readonly>
				<label for="subTotal">Sub Total</label>
			  </div>
			</div>
			<div class="col-md-6">
			  <div class="form-floating">
				<input type="number" value="<?php echo $invoiceValues['amountOffered']; ?>" class="form-control" id="totalAftertax" name="totalAftertax" placeholder="Total" readonly>
				<label for="totalAftertax">Total</label>
			  </div>
			</div>
			<div class="col-md-6">
			  <div class="form-floating">
				<input type="text" value="<?php echo $invoiceValues['amountReceived']; ?>" class="form-control" id="previousPayment" name="previousPayment" placeholder="Previous Payment"readonly >
				<label for="previousPayment">Previous Payment</label>
			  </div>
			</div>
			<div class="col-md-6">
			  <div class="form-floating">
				<input type="text" value="" class="form-control" id="amountPaid" name="amountPaid" placeholder="Amount paid">
				<label for="amountPaid">Amount Paying</label>
			  </div>
			</div>
			<div class="col-md-6">
			  <div class="form-floating">
				<input type="number" value="<?php echo $invoiceValues['amountPending']; ?>"  class="form-control" name="amountDue" id="amountDue" placeholder="Amount Due" readonly>
