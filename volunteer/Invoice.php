...
class Invoice{
	...
	public function saveUser($POST) {	
		...
		public function getUserContributionCount($user){
			$sqlQuery = "
				SELECT COUNT(*) AS user_count
				FROM ".$this->eventsInvoiceOrderTable."
	...
	public function getSambhavanaListByVolunteer($user){
		$sqlQuery = "
		SELECT * FROM ".$this->eventsInvoiceOrderTable."
		WHERE collected_by = '$user'
		ORDER BY date DESC";
...
return  $this->getData($sql);
	...
	public function getSambhavanaListByCriteriaByVolunteer( $event, $status , $date,$houseNumber,$sambhavanaId,$user){
		echo "<script>console.log('Inside function: ' );</script>";
		try{
